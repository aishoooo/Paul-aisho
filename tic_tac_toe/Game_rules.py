...
class morpion:
    ...
    def __win(self, player):
        if (self.board[0][0] == player.symbol and self.board[1][0] == player.symbol  and self.board[2][0] == player.symbol ) :
            ...
            print (player.nom + " a gagné")
            return (True)
        elif (self.board[0][0]== player.symbol and self.board[0][1] == player.symbol  and self.board[0][2] == player.symbol ):
            print (player.nom + " a gagné")
            return (True)
            ...
            print (player.nom + " a gagné")
            return (True)
        elif (self.board[2][0]== player.symbol and self.board[1][1] == player.symbol  and self.board[0][2] == player.symbol ):
            print (player.nom + " a gagné")
            return (True)
